...
//hooks
import { useProgressMutation,useProgress } from "./useProgress";
...
const InfoCourse = ({
  ...
  const currentUserProgress= progressResponse?.data ?? initialProgress;


  console.log("progress",currentUserProgress);
  ...
  const completeChapters= currentUserProgress.filter((progress)=>progress.isCompleted===true).length;
